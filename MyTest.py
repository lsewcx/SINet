...
parser.add_argument('--image_root', type=str, default="COD10K/Imgs/", help='the root directory of test images')
parser.add_argument('--gt_root', type=str, default="COD10K/GT/", help='the root directory of ground truth images')
