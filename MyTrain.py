...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--epoch", type=int, default=100, help="epoch number, default=30"
    )
    parser.add_argument(
        "--lr", type=float, default=1e-4, help="init learning rate, try `lr=1e-4`"
    )
    parser.add_argument(
        "--batchsize",
        type=int,
    ...
    parser.add_argument(
        "--decay_epoch", type=int, default=30, help="every N epochs decay lr"
    )
    ...
    parser.add_argument(
        "--train_img_dir",
        type=str,
        default="/kaggle/input/cod10k-train/TrainDataset/Imgs/",
    )
    parser.add_argument(
        "--train_gt_dir",
        type=str,
        default="/kaggle/input/cod10k-train/TrainDataset/GT/",
    )
